...
function AndroidBanner() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-[60] mx-auto max-w-sm animate-in slide-in-from-bottom-4 fade-in duration-300">
      <div className="flex items-center gap-3 rounded-2xl border border-white/[0.08] bg-card p-4 shadow-2xl backdrop-blur-xl">
...
function IosGuide() {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-end justify-center bg-black/70 p-4 backdrop-blur-sm sm:items-center">
      <div className="w-full max-w-sm animate-in zoom-in-95 fade-in duration-200 rounded-3xl border border-white/[0.08] bg-card p-6 shadow-2xl">
