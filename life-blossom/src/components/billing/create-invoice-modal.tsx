    ...
    fetch("/api/staff?page_size=500")
      ...
      .then((json) => {
        if (json.success) {
          ...
          setAttendingStaff(rows.filter((s: StaffUser) => ["doctor", "nurse", "admin", "accountant"].includes(s.role)));
        }
      })
      .catch(() => {});
  }, [open]);
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            {selectedPatient ? (
              ...
              <div>
                ...
                {patientsLoaded && (
                  <div className="mt-1 rounded-xl border border-white/[0.06] bg-card backdrop-blur-xl max-h-56 overflow-y-auto">
          ...
          {selectedPatient && (
            <div>
              ...
              <select
                className={cn("w-full " + inputClass, "bg-card rounded-lg border px-3")}
          ...
          {selectedPatient && (
            <div>
              <label className="block text-xs font-medium text-slate-500 dark:text-white/50 mb-1.5">Quick Add Services</label>
              <div className="flex flex-wrap gap-1.5">
                {[
                  ...
                  <button
                    ...
                    className="h-7 px-2.5 rounded-md bg-slate-100 dark:bg-white/[0.04] text-xs font-medium text-slate-600 dark:text-white/70 hover:bg-[#e0a84a]/10 hover:text-[#e0a84a] transition-colors whitespace-nowrap"
                  >
                    + {p.label}
                  </button>
                ))}
          ...
          {selectedPatient && (
            <div>
              ...
              <Textarea
                ...
                rows={3}
                className="border-white/[0.08] bg-white/[0.03] text-black dark:text-white/90 placeholder:text-white/30 text-sm"
                value={notes}
