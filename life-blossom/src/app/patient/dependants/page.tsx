          ...
          {dependants.map((d) => {
            ...
            return (
              <Link
                ...
                className="group relative rounded-2xl border border-border bg-card backdrop-blur-xl p-4 overflow-hidden transition-all duration-300 hover:border-white/[0.12] hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[#e0a84a]/5"
              >
                ...
                <p className="text-sm font-bold text-foreground mt-3 truncate">{d.full_name}</p>
                ...
                <div className="mt-3 flex items-center justify-between border-t border-white/[0.05] pt-2.5">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <ChevronRight className="w-3.5 h-3.5 text-muted-foreground group-hover:text-[#e0a84a] group-hover:translate-x-0.5 transition-all" />
                  </div>
                </div>
              </Link>
            );
