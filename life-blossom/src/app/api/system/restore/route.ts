...
const T = {
  ...
  invoices: ["id", "org_id", "patient_id", "invoice_number", "issue_date", "due_date", "status", "subtotal", "tax", "discount", "total", "paid_amount", "attending_staff_id", "notes", "created_by", "created_at", "updated_at"],
  invoice_items: ["id", "invoice_id", "description", "quantity", "unit_price", "vat_percent", "vat_amount", "line_total", "created_at"],
