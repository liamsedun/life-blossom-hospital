...
type Expense = {
  ...
  vendor: string | null; notes: string | null; bank_account_id: string | null;
...
interface ExpenseForm {
  ...
  payment_method: string; vendor: string; notes: string; bank_account_id: string;
}
...
const emptyForm: ExpenseForm = {
  ...
  payment_method: "cash", vendor: "", notes: "", bank_account_id: "",
};
        ...
        <DialogContent className="sm:max-w-md border-white/[0.06] bg-card backdrop-blur-xl text-foreground">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {bankAccounts.length > 0 && (
              <div>
                <label className="block text-xs font-medium text-white/50 mb-1">Pay From (Bank Account)</label>
